              ...
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="min-w-0 w-full h-8 px-2.5 pr-8 eco-clip-sm bg-paper-warm/70 border border-paper-deep/40 text-[12px] font-mono text-ink-soft outline-none focus:border-bamboo/40 focus:bg-paper-warm/90 transition-colors"
                  />
                </div>
                <button
                  type="button"
                  ...
                  disabled={!cdkInput}
                  className="h-8 w-8 flex items-center justify-center eco-clip-sm border border-paper-deep/45 text-ink-ghost hover:text-ink-faint hover:bg-paper-warm disabled:opacity-30 disabled:cursor-not-allowed transition-colors cursor-pointer shrink-0"
                  title={
                    showCdk
...
function renderDownloadCard({
  ...
  return (
    <div className="space-y-2 eco-clip-sm border border-paper-deep/25 bg-paper-warm/40 px-3 py-3">
      ...
      <div className="flex gap-2">
        {canDownload ? (
          <button
            type="button"
            onClick={onDownload}
            className="h-8 px-3 eco-clip-sm bg-bamboo text-[11px] text-paper hover:bg-bamboo-light transition-colors cursor-pointer"
          >
        ...
        {canCancel ? (
          <button
            type="button"
            onClick={onCancel}
            className="h-8 px-3 eco-clip-sm border border-paper-deep/45 text-[11px] text-ink-faint hover:text-red-400 hover:bg-danger-bg transition-colors cursor-pointer"
          >
...
function UpdateToggleRow({ label, checked, disabled = false, onChange }: UpdateToggleRowProps) {
  return (
    <label
      className={`flex items-center justify-between h-9 eco-clip-sm px-2.5 bg-paper-warm/45 border border-paper-deep/25 ${
