...
import { EcoBrackets, EcoDecoLayer, EcoHexMark } from "./EcoDeco";
...
export function MainWindow({
  ...
  const handleMigrateDataDir = async () => {
    ...
    try {
      ...
      if (!dir) return;
      // 后端会在所选目录下创建 ecology 子目录存放数据；先告知用户，
      // 避免其在文件管理器打开所选目录看到"空文件夹"而误判数据丢失
      const confirmed = window.confirm(
        t("settings.dataDir.confirmSubdir", {
          dir,
          defaultValue: "数据将存放在「{{dir}}」下的 ecology 子文件夹中，是否继续？",
        }),
      );
      if (!confirmed) return;
  ...
  return (
    <div className="w-full h-screen flex flex-col">
      <div className="relative noise-bg bg-cloud overflow-hidden flex flex-col flex-1">
        ...
        <EcoDecoLayer />
        <div
          className={`relative z-10 flex items-center justify-between h-12 bg-paper/55 backdrop-blur-[1px] border-b border-paper-deep/30 shrink-0 select-none cursor-default ${
            isMacOS ? "pl-20 pr-5" : "pl-4 pr-0"
          }`}
          onMouseDown={handleTitleBarMouseDown}
        >
          {/* 顶部生态青能级线 + 底部刻度尺 */}
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-eco-teal/80 to-transparent pointer-events-none" />
          <div className="eco-ticks absolute bottom-0 left-0 right-0 h-[5px] pointer-events-none opacity-50" />

          <div className="flex items-center gap-3 min-w-0">
            {/* 莱茵六边形徽标 */}
            <div className="eco-clip-hex w-7 h-7 bg-gradient-to-br from-eco-teal to-eco-tealdeep flex items-center justify-center shrink-0 shadow-[0_0_14px_rgba(15,154,138,0.45)]">
              <EcoHexMark size={15} className="text-white" />
            </div>
            {/* 双语品牌铭牌 */}
            <div className="flex flex-col justify-center leading-none shrink-0">
              <span className="text-[14px] font-display font-semibold text-ink tracking-[0.14em] leading-none">
                生态科档案
              </span>
              <span className="mt-[5px] text-[7.5px] font-brand text-eco-teal tracking-[0.18em] uppercase leading-none">
                Rhine Lab · Ecological Section
              </span>
            </div>
            <div className="w-px h-6 bg-paper-deep/50 mx-0.5 shrink-0" />
            {/* 当前档案编号 */}
            <div className="eco-clip-tag hidden sm:flex items-center h-[18px] px-2 bg-eco-teal/10 border border-eco-teal/25 shrink-0">
              <span className="text-[9px] font-mono tracking-[0.14em] text-eco-tealdeep uppercase leading-none">
                {selectedId ? "Record // Active" : "Archive // Standby"}
              </span>
            </div>
          ...
          <div className="flex items-center">
            <button
              ...
              className="w-10 h-12 flex items-center justify-center text-ink-ghost hover:text-bamboo hover:bg-bamboo-mist/50 transition-all cursor-pointer"
            ...
            <button
              ...
              className="w-10 h-12 flex items-center justify-center text-ink-ghost hover:text-ink-faint hover:bg-paper-warm transition-all cursor-pointer"
            ...
            <button
              ...
              className={`h-12 flex items-center justify-center overflow-hidden text-ink-ghost hover:text-ink-faint hover:bg-paper-warm transition-[width,padding,gap,background-color,color] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] cursor-pointer ${
            ...
            {!isMacOS && (
              <>
                ...
                <button
                  ...
                  className="w-11 h-12 flex items-center justify-center text-ink-ghost hover:text-eco-teal hover:bg-eco-teal/10 transition-all cursor-pointer"
                ...
                <button
                  onClick={handleClose}
                  className="w-11 h-12 flex items-center justify-center text-ink-ghost hover:text-red-500 hover:bg-danger-bg transition-all cursor-pointer"
        ...
        <div className="relative z-10 flex flex-1 min-h-0">
          ...
          >
            <div className="flex flex-col h-full" style={{ width: `${sidebarWidth}px` }}>
              <div className="px-3 pt-3 pb-2 shrink-0">
                <div className="flex items-center gap-2 px-2.5 h-8 eco-clip-sm bg-paper-warm/80 border border-paper-deep/40 focus-within:border-eco-teal/50 focus-within:bg-cloud focus-within:shadow-[0_0_0_1px_rgba(15,154,138,0.2),0_4px_16px_rgba(15,154,138,0.12)] transition-all">
                  <svg
                    width="13"
                    height="13"
                    viewBox="0 0 24 24"
              ...
              <div className="px-3 pb-2 shrink-0 space-y-1">
                <button
                  ...
                  className="eco-clip-btn relative w-full flex items-center gap-2 px-3 py-[7px] text-[12px] font-display font-medium tracking-[0.06em] text-white bg-gradient-to-r from-eco-teal to-eco-tealdeep shadow-[0_4px_16px_rgba(15,154,138,0.35)] hover:shadow-[0_6px_22px_rgba(15,154,138,0.5)] hover:brightness-110 active:brightness-95 transition-all cursor-pointer group overflow-hidden"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/12 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 pointer-events-none" />
                  <svg
                    width="13"
                    height="13"
                    viewBox="0 0 24 24"
                  ...
                  <span className="ml-auto text-[8px] font-mono tracking-[0.18em] uppercase opacity-70">
                    New
                  </span>
                </button>
                <button
                  onClick={() => void handleImportNote()}
                  className="eco-clip-btn w-full flex items-center gap-2 px-3 py-[7px] text-[12px] font-display tracking-[0.04em] text-eco-tealdeep bg-eco-teal/[0.07] border border-eco-teal/25 hover:bg-eco-teal/[0.14] hover:border-eco-teal/45 hover:shadow-[0_4px_14px_rgba(15,154,138,0.18)] transition-all cursor-pointer group"
                >
                  <svg
                    width="13"
                    height="13"
                  ...
                  <span className="ml-auto text-[8px] font-mono tracking-[0.18em] uppercase opacity-50">
                    .md
                  </span>
                </button>
              </div>
              ...
              <div className="flex items-center justify-between px-5 pb-1.5 shrink-0">
                <span className="eco-label text-[10px] text-ink-ghost font-mono tracking-wider uppercase">
                  {t("common.noteCount", {
              ...
              {showCategoryInput && (
                <div className="px-3 pb-2 shrink-0">
                  <input
                    ...
                    className="w-full px-2.5 h-7 eco-clip-sm text-[12px] font-body text-ink bg-paper-warm/80 border border-eco-teal/30 focus:border-eco-teal/60 focus:shadow-[0_0_0_1px_rgba(15,154,138,0.2)] placeholder:text-ink-ghost/60"
                  />
                </div>
              )}
                      ...
                      {externalFiles.map((file) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full text-left eco-clip-sm px-3 py-2.5 transition-all duration-[600ms] cursor-pointer group relative ${
                              isSelected
                                ? "bg-bamboo-mist/70 shadow-[inset_0_0_0_1px_rgba(15,154,138,0.28)]"
                                : isHovered
                                  ? "bg-paper-warm/70"
                                  : "bg-transparent"
                            }`}
                  ...
                  {categoryGroups.map((group: CategoryGroup) => {
                    if (!group.category) {
                      return (
                        <div
                          ...
                          className={`eco-clip-sm transition-all duration-200 ${
                            dragOverCategory === ""
                              ? "bg-eco-teal/10 shadow-[inset_0_0_0_1px_rgba(15,154,138,0.3)]"
                              : ""
                          }`}
                          onDragOver={(e) => {
                            e.preventDefault();
                    ...
                    return (
                      <div key={group.category} className="px-2 mb-0.5">
                        <div
                          className={`flex items-center gap-1.5 px-2.5 py-1.5 eco-clip-sm group/cat cursor-pointer select-none transition-all duration-200 ${
                            dragOverCategory === group.category
                              ? "bg-eco-teal/15 border border-eco-teal/40 shadow-[0_0_14px_rgba(15,154,138,0.15)]"
                              : isCollapsed
                                ? "bg-transparent border border-eco-teal/15 hover:border-eco-teal/30"
                                : "bg-eco-teal/[0.07] border border-eco-teal/20"
                          }`}
                              ...
                              group.notes.map((note) => {
                                ...
                                return (
                                  <div
                                    ...
                                    onMouseEnter={() => setHoveredId(note.id)}
                                    onMouseLeave={() => setHoveredId(null)}
                                    className={`w-full text-left eco-clip-sm mx-1 px-2.5 py-2 transition-all duration-[600ms] cursor-pointer group relative ${
                                      isSelected
                                        ? "bg-bamboo-mist/70 shadow-[inset_0_0_0_1px_rgba(15,154,138,0.28)]"
                                        : isHovered
                                          ? "bg-paper-warm/70"
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <div className="flex items-center justify-between px-4 h-10 border-b border-eco-teal/20 shrink-0 bg-gradient-to-r from-eco-teal/[0.06] via-transparent to-transparent">
              <div className="flex items-center gap-1">
                <button
                  onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
                  className="w-7 h-7 flex items-center justify-center eco-clip-sm text-ink-ghost hover:text-eco-tealdeep hover:bg-eco-teal/10 hover:shadow-[0_0_12px_rgba(15,154,138,0.18)] transition-all cursor-pointer"
                  title={
                    sidebarCollapsed
                ...
                <button
                  ...
                  className={`w-7 h-7 flex items-center justify-center eco-clip-sm transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed ${
                    selectedTilePinned
                ...
                <button
                  ...
                  onClick={handleUndo}
                  disabled={!selectedId}
                  className="w-7 h-7 flex items-center justify-center eco-clip-sm text-ink-ghost hover:text-eco-tealdeep hover:bg-eco-teal/10 hover:shadow-[0_0_12px_rgba(15,154,138,0.18)] transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
                ...
                <button
                  ...
                  className="eco-clip-sm px-3 h-7 flex items-center justify-center text-[11px] font-display font-medium tracking-[0.1em] text-eco-tealdeep bg-eco-teal/[0.08] border border-eco-teal/25 hover:bg-eco-teal/[0.16] hover:border-eco-teal/45 hover:shadow-[0_2px_12px_rgba(15,154,138,0.22)] transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
                ...
                {deleteConfirm ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-2 h-6 eco-clip-sm text-[11px] font-display tracking-[0.06em] text-white bg-red-400/90 hover:bg-red-500 hover:shadow-[0_2px_10px_rgba(211,63,51,0.35)] transition-all cursor-pointer whitespace-nowrap outline-none"
                    >
                    ...
                    <button
                      ...
                      className="px-2 h-6 eco-clip-sm text-[11px] font-display tracking-[0.06em] text-ink-faint hover:text-eco-tealdeep hover:bg-eco-teal/10 transition-all cursor-pointer outline-none"
                    >
                  ...
                  <button
                    ...
                    disabled={!selectedId}
                    className="w-7 h-7 flex items-center justify-center eco-clip-sm text-ink-ghost hover:text-red-400 hover:bg-danger-bg transition-all cursor-pointer disabled:opacity-30 disabled:cursor-not-allowed"
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1.5">
                <span className="w-1.5 h-1.5 bg-eco-teal shadow-[0_0_6px_rgba(15,154,138,0.6)] shrink-0" />
                <span className="text-[9px] font-mono tracking-[0.3em] uppercase text-eco-teal/80 leading-none">
                  {selectedId ? "Specimen Record // Active" : "Specimen Record // Standby"}
                </span>
                <span className="flex-1 h-px bg-gradient-to-r from-eco-teal/30 to-transparent" />
              </div>
              <input
                type="text"
                value={title}
                ...
                disabled={!selectedId}
                className="w-full text-[20px] font-display font-bold text-ink placeholder:text-ink-ghost/50 tracking-wide disabled:opacity-60 border-b border-transparent focus:border-eco-teal/40 transition-colors"
              />
            ...
            >
              {selectedId && <EcoBrackets size={14} inset={6} className="opacity-40 z-10" />}
              {!selectedId && !isLoading ? (
                <div className="flex-1 flex flex-col items-center justify-center gap-5 select-none">
                  {/* 呼吸六边形徽标 */}
                  <div className="eco-hex-pulse eco-clip-hex w-16 h-16 bg-gradient-to-br from-eco-teal/25 to-eco-cyan/10 flex items-center justify-center shadow-[0_0_28px_rgba(15,154,138,0.25)]">
                    <EcoHexMark size={30} className="text-eco-teal" />
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <span className="text-[10px] font-brand tracking-[0.34em] uppercase text-eco-teal/90">
                      Rhine Lab · Ecological Section
                    </span>
                    <span className="text-[13px] text-ink-ghost">
                      {t("main.editor.emptyHint", { defaultValue: "选择或新建一篇笔记" })}
                    </span>
                    <span className="text-[9px] font-mono tracking-[0.24em] uppercase text-ink-ghost/50">
                      Standby // Waiting for specimen input
                    </span>
                  </div>
                </div>
              ) : (
                      ...
                      <div className="flex items-center gap-0.5 px-4 pt-2 pb-1 shrink-0">
                        {toolbarButtons.map((button) => (
                          <button
                            ...
                            className={`w-6 h-6 flex items-center justify-center eco-clip-sm text-[11px] font-display text-ink-ghost hover:text-eco-tealdeep hover:bg-eco-teal/10 hover:shadow-[0_0_10px_rgba(15,154,138,0.16)] transition-all cursor-pointer ${button.style}`}
                          >
                            {button.label}
                          </button>
                        ))}
            ...
            <div className="flex items-center justify-between px-4 h-7 border-t border-eco-teal/25 bg-gradient-to-r from-eco-teal/[0.07] via-transparent to-eco-teal/[0.04] shrink-0">
              <div className="flex items-center gap-3">
                <span className="eco-status-dot" />
                <span className="text-[10px] font-mono tracking-[0.18em] uppercase text-eco-teal/90">
                  SYS // Nominal
                </span>
                <span className="text-[10px] text-ink-ghost/40">|</span>
                <span className="text-[10px] text-ink-ghost font-mono tabular-nums">
              ...
              <div className="flex items-center gap-3">
                ...
                {appVersion && (
                  <>
                    <span className="text-[10px] text-ink-ghost/40">|</span>
                    <span className="text-[10px] font-mono tracking-[0.14em] uppercase text-eco-teal/70">
                      ECO-TERM v{appVersion}
                    </span>
                  </>
                )}
              </div>
      ...
      {noteMenu && noteMenuTarget && (
        <div
          ref={noteMenuRef}
          className={`popup-menu fixed z-[9999] min-w-[168px] py-1.5 bg-cloud/95 backdrop-blur-sm border border-eco-teal/25 eco-clip-card shadow-[0_12px_36px_rgba(11,60,50,0.18)] overflow-x-hidden overflow-y-auto select-none ${noteMenuClosing ? "animate-menu-exit" : "animate-menu-enter"}`}
          style={{
      ...
      {categoryMenu && (
        <div
          ref={categoryMenuRef}
          className={`popup-menu fixed z-[9999] min-w-[140px] py-1.5 bg-cloud/95 backdrop-blur-sm border border-eco-teal/25 eco-clip-card shadow-[0_12px_36px_rgba(11,60,50,0.18)] overflow-x-hidden overflow-y-auto select-none ${categoryMenuClosing ? "animate-menu-exit" : "animate-menu-enter"}`}
