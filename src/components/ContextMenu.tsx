  ...
  return (
    <>
      ...
      {menu && (
        <div
          ref={menuRef}
          className={`fixed z-[9999] min-w-[152px] py-1.5 bg-cloud/95 backdrop-blur-sm border border-eco-teal/25 eco-clip-card shadow-[0_12px_36px_rgba(11,60,50,0.18)] overflow-x-hidden overflow-y-auto select-none ${menuClosing ? "animate-menu-exit" : "animate-menu-enter"}`}
          style={{
