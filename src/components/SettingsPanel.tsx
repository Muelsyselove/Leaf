    ...
    <aside className="w-[360px] h-full shrink-0 border-l border-paper-deep/30 bg-cloud/92 backdrop-blur-sm flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hidden px-4 py-4 space-y-5">
        ...
        <section className="space-y-2">
          ...
          <div className="flex gap-2">
            <input
              ...
              readOnly
              className="min-w-0 flex-1 h-8 px-2.5 eco-clip-sm bg-paper-warm/70 border border-paper-deep/40 text-[11px] font-mono text-ink-faint truncate"
            />
            <button
              type="button"
              onClick={onMigrateDataDir}
              className="h-8 px-3 eco-clip-sm border border-paper-deep/45 text-[11px] text-ink-faint hover:text-bamboo hover:bg-bamboo-mist/50 transition-colors cursor-pointer"
            >
        ...
        <section className="space-y-2">
          ...
          <div className="flex items-center gap-3 h-9 eco-clip-sm px-2.5 bg-paper-warm/45 border border-paper-deep/25">
            <input
              type="range"
              min={8}
              max={30}
          ...
          {config.tileColorMode === "custom" && (
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-10 h-8 eco-clip-sm border border-paper-deep/40 bg-paper-warm/70 cursor-pointer"
              />
              <input
                type="text"
                ...
                placeholder="#0e1712"
                spellCheck={false}
                className="min-w-0 flex-1 h-8 px-2.5 eco-clip-sm bg-paper-warm/70 border border-paper-deep/40 text-[12px] font-mono text-ink-soft outline-none"
              />
              <button
                type="button"
                onClick={() => setConfigValue("tileColor", DEFAULT_TILE_COLOR)}
                className="h-8 px-2.5 eco-clip-sm border border-paper-deep/45 text-[11px] text-ink-faint hover:text-bamboo hover:bg-bamboo-mist/50 transition-colors cursor-pointer whitespace-nowrap"
              >
          ...
          <div className="flex gap-2">
            ...
            {config.backgroundImagePath && (
              <button
                ...
                className="h-8 px-3 eco-clip-sm border border-red-400/40 text-[11px] text-red-400 hover:bg-red-400/10 transition-colors cursor-pointer"
              >
...
function ToggleRow({ label, checked, onChange }: ToggleRowProps) {
  return (
    <label className="flex items-center justify-between h-9 eco-clip-sm px-2.5 bg-paper-warm/45 border border-paper-deep/25 cursor-pointer">
      ...
      >
        <div
          className={`absolute top-[2px] left-[2px] w-[14px] h-[14px] rounded-full bg-paper shadow-[0_1px_2px_rgba(0,0,0,0.3)] transition-transform duration-250 ease-[cubic-bezier(0.22,1,0.36,1)] ${
    ...
    <div ref={containerRef} className="relative space-y-1.5">
      <div className="flex gap-2">
        <button
          ...
          className={`min-w-0 flex-1 h-8 px-2.5 eco-clip-sm border text-[12px] flex items-center gap-2 cursor-pointer transition-colors ${
        ...
        <button
          ...
          className="w-8 h-8 eco-clip-sm border border-paper-deep/45 text-[15px] leading-none text-ink-faint hover:text-red-400 hover:bg-paper-warm/70 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
        >
          ×
        </button>
        <button
          ...
          className="h-8 px-3 eco-clip-sm border border-paper-deep/45 text-[11px] text-ink-faint hover:text-bamboo hover:bg-bamboo-mist/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
        >
          {isChecking
