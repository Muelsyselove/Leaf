...
mod tests {
    ...
    fn reuses_verified_existing_download_in_run() {
        ...
        let manifest = format!(
            r#"{{
  "schemaVersion": 1,
  "appId": "com.rhine-lab.ecology-section-archive",
  "productName": "生态科档案",
  "channel": "stable",
  "version": "1.0.5",
  "tag": "v1.0.5",
  ...
  "assets": [
    {{
      ...
      "sha256": "{sha256}",
      "size": {size},
      "githubUrl": "https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/{asset_name}"
    }}
  ]
}}"#,
            sha256 = sha256,
  ...
  "assets": [
    {{
      ...
      "size": {size},
      "githubUrl": "https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/{asset_name}",
      "mirrorChyanUrl": "https://mirrorchyan.com/resources/download/ecology-section-archive-1.0.5-macos-aarch64"
    }}
  ]
}}"#,
            sha256 = sha256,
        ...
        current_state.asset_url =
            Some("https://mirrorchyan.com/resources/download/ecology-section-archive-1.0.5".into());
  ...
  "assets": [
    ...
    fn direct_url_source_detection_distinguishes_hosts() {
        assert!(direct_url_matches_source(
            "https://mirrorchyan.com/resources/download/ecology-section-archive",
        ...
        assert!(direct_url_matches_source(
            "https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/asset.zip",
            &DownloadSourceUsed::Github
        ));
        assert!(!direct_url_matches_source(
            "https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/asset.zip",
