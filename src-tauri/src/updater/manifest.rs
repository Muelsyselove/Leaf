...
mod tests {
          ...
          "assets": [
            {
              ...
              "size": 1,
              "githubUrl": "https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/asset.zip"
            }
          ]
        }"#;
    ...
    fn selects_windows_nsis_asset() {
        ...
        assert_eq!(
            asset.name,
            "ecology-section-archive_1.0.5_windows_x64_nsis.exe"
        );
    }
    ...
    fn selects_windows_portable_asset() {
        ...
        assert_eq!(
            asset.name,
            "ecology-section-archive_1.0.5_windows_x64_portable.exe"
        );
    }
