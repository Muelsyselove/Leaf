...
const MIRROR_CHYAN_MANIFEST_PATH_ENV: &str = "ECOLOGY_SECTION_ARCHIVE_UPDATE_MIRROR_MANIFEST_PATH";
const GITHUB_MANIFEST_PATH_ENV: &str = "ECOLOGY_SECTION_ARCHIVE_UPDATE_GITHUB_MANIFEST_PATH";
const GITHUB_REPO_ENV: &str = "ECOLOGY_SECTION_ARCHIVE_UPDATE_GITHUB_REPO";
const DEFAULT_GITHUB_REPO: &str = "Muelsyselove/Rhine-Lab-Ecological-Section";
const MIRROR_CHYAN_API_BASE: &str = "https://mirrorchyan.com/api/resources";
const MIRROR_CHYAN_RES_ID: &str = "ecology-section-archive";
const MIRROR_CHYAN_RES_ID_OVERRIDE_ENV: &str = "ECOLOGY_SECTION_ARCHIVE_MIRROR_CHYAN_RES_ID";
const MIRROR_CHYAN_USER_AGENT: &str = "ecology_section_archive";
...
impl MirrorChyanProvider {
    pub fn from_env() -> Self {
        Self {
            ...
            cdk: None,
            offline: env::var("ECOLOGY_SECTION_ARCHIVE_UPDATE_OFFLINE").is_ok(),
        }
    }
...
fn build_mirror_chyan_api_client() -> Result<Client, AppError> {
    Client::builder()
        ...
        .user_agent("ecology-section-archive-updater")
        .build()
...
fn check_mirror_chyan_api(
    ...
    let asset_name = mirror_chyan_asset_url
        ...
        .unwrap_or_else(|| format!("ecology-section-archive_{version_str}_{os}_{arch}"));
...
mod tests {
    ...
    fn stores_asset_url_for_recommended_download_source() {
        ...
        assert_eq!(
            ...
            Some("https://mirrorchyan.com/resources/download/ecology-section-archive-1.0.5-macos-aarch64")
        );
    ...
    fn merge_candidates_enriches_mirror_chyan_result_with_github_metadata() {
        let mirror_chyan_candidate = UpdateCandidate {
            ...
            asset_size: 0,
            asset_url: Some(
                "https://mirrorchyan.com/resources/download/ecology-section-archive".into(),
            ),
        ...
        let github_candidate = UpdateCandidate {
            ...
            mandatory: false,
            asset_name: "ecology-section-archive_1.0.5_macos_aarch64_app.zip".into(),
            asset_sha256: Some("3333333333333333333333333333333333333333333333333333333333333333".into()),
            asset_size: 22345678,
            asset_url: Some("https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/ecology-section-archive_1.0.5_macos_aarch64_app.zip".into()),
            mirror_chyan_asset_url: None,
            github_asset_url: Some("https://github.com/Muelsyselove/Rhine-Lab-Ecological-Section/releases/download/v1.0.5/ecology-section-archive_1.0.5_macos_aarch64_app.zip".into()),
            can_download_from_mirror_chyan: false,
            can_download_from_github: true,
            sha256_verification_enabled: true,
        };
        ...
        assert_eq!(
            merged.asset_name,
            "ecology-section-archive_1.0.5_macos_aarch64_app.zip"
        );
    ...
    fn run_preserves_previous_available_update_when_check_fails() {
        ...
        previous.asset_name = Some("ecology-section-archive_1.0.5_macos_aarch64_app.zip".into());
        ...
        assert_eq!(
            ...
            Some("ecology-section-archive_1.0.5_macos_aarch64_app.zip")
        );
