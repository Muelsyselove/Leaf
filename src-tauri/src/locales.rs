...
pub fn app_name(locale: Locale) -> &'static str {
    match locale {
        Locale::ZhCn => "生态科档案",
        Locale::EnUs => "Ecology Section Archive",
        Locale::ZhHk => "生態科檔案",
    }
}
...
pub fn notepad_window_title(locale: Locale) -> &'static str {
    match locale {
        Locale::ZhCn => "生态科档案 · 速记",
        Locale::EnUs => "Ecology Section Archive · Quick Note",
        Locale::ZhHk => "生態科檔案 · 速記",
    }
}

pub fn tile_window_title(locale: Locale) -> &'static str {
    match locale {
        Locale::ZhCn => "生态科档案 · 磁贴",
        Locale::EnUs => "Ecology Section Archive · Pin Mode",
        Locale::ZhHk => "生態科檔案 · 磁貼",
    }
}
...
mod tests {
    ...
    fn localizes_native_shell_strings_for_supported_locales() {
        assert_eq!(app_name(Locale::ZhCn), "生态科档案");
        assert_eq!(app_name(Locale::EnUs), "Ecology Section Archive");
        assert_eq!(app_name(Locale::ZhHk), "生態科檔案");

        assert_eq!(
            notepad_window_title(Locale::EnUs),
            "Ecology Section Archive · Quick Note"
        );
        assert_eq!(tile_window_title(Locale::ZhHk), "生態科檔案 · 磁貼");
        assert_eq!(tray_tooltip(Locale::EnUs), "Ecology Section Archive");
